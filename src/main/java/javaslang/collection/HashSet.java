...
public final class HashSet<T> implements Set<T>, Serializable {
  ...
  public static HashSet<?> EMPTY=new HashSet<>(HashArrayMappedTrie.empty());
  public HashArrayMappedTrie<T,T> tree;
  public transient Lazy<Integer> hash;
  public HashSet(  HashArrayMappedTrie<T,T> tree){
    this.tree=tree;
    this.hash=Lazy.of(() -> Traversable.hash(tree::iterator));
  }
  @SuppressWarnings("unchecked") public static <T>HashSet<T> empty(){
    return (HashSet<T>)EMPTY;
  }
  /** 
 * Returns a  {@link java.util.stream.Collector} which may be used in conjunction with{@link java.util.stream.Stream#collect(java.util.stream.Collector)} to obtain a {@link javaslang.collection.HashSet}.
 ...
 */
  ...
  /** 
 * Creates a HashSet of the given elements. <pre><code>HashSet.of(1, 2, 3, 4)</code></pre>
 * @param < T >      Component type of the HashSet.
 ...
 */
  ...
  /** 
 * Returns an HashSet containing  {@code n} values of a given Function {@code f}over a range of integer values from 0 to  {@code n - 1}.
 * @param < T > Component type of the HashSet
 ...
 */
  @SuppressWarnings("unchecked") public static <T>HashSet<T> ofAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
 ...
 */
  ...
  /** 
 * Creates a HashSet of int numbers starting from  {@code from}, extending to  {@code toExclusive - 1}. <p> Examples: <pre> <code> HashSet.range(0, 0)  // = HashSet() HashSet.range(2, 0)  // = HashSet() HashSet.range(-2, 2) // = HashSet(-2, -1, 0, 1) </code> </pre>
 ...
 */
  ...
  /** 
 * Creates a HashSet of int numbers starting from  {@code from}, extending to  {@code toExclusive - 1}, with  {@code step}. <p> Examples: <pre> <code> HashSet.rangeBy(1, 3, 1)  // = HashSet(1, 2) HashSet.rangeBy(1, 4, 2)  // = HashSet(1, 3) HashSet.rangeBy(4, 1, -2) // = HashSet(4, 2) HashSet.rangeBy(4, 1, 2)  // = HashSet() </code> </pre>
 * @param from        the first number
 * @param toExclusive the last number + 1
 * @param step        the step
 ...
 */
  ...
  /** 
 * Creates a HashSet of long numbers starting from  {@code from}, extending to  {@code toExclusive - 1}. <p> Examples: <pre> <code> HashSet.range(0L, 0L)  // = HashSet() HashSet.range(2L, 0L)  // = HashSet() HashSet.range(-2L, 2L) // = HashSet(-2L, -1L, 0L, 1L) </code> </pre>
 * @param from        the first number
 * @param toExclusive the last number + 1
 ...
 */
  ...
  /** 
 * Creates a HashSet of long numbers starting from  {@code from}, extending to  {@code toExclusive - 1}, with  {@code step}. <p> Examples: <pre> <code> HashSet.rangeBy(1L, 3L, 1L)  // = HashSet(1L, 2L) HashSet.rangeBy(1L, 4L, 2L)  // = HashSet(1L, 3L) HashSet.rangeBy(4L, 1L, -2L) // = HashSet(4L, 2L) HashSet.rangeBy(4L, 1L, 2L)  // = HashSet() </code> </pre>
 * @param from        the first number
 * @param toExclusive the last number + 1
 * @param step        the step
 * @return a range of long values as specified or the empty range if<br>{@code from >= toInclusive} and {@code step > 0} or<br>{@code from <= toInclusive} and {@code step < 0}
 ...
 */
  ...
  /** 
 * Creates a HashSet of int numbers starting from  {@code from}, extending to  {@code toInclusive}. <p> Examples: <pre> <code> HashSet.rangeClosed(0, 0)  // = HashSet(0) HashSet.rangeClosed(2, 0)  // = HashSet() HashSet.rangeClosed(-2, 2) // = HashSet(-2, -1, 0, 1, 2) </code> </pre>
 * @param from        the first number
 ...
 */
  ...
  /** 
 * Creates a HashSet of int numbers starting from  {@code from}, extending to  {@code toInclusive}, with  {@code step}. <p> Examples: <pre> <code> HashSet.rangeClosedBy(1, 3, 1)  // = HashSet(1, 2, 3) HashSet.rangeClosedBy(1, 4, 2)  // = HashSet(1, 3) HashSet.rangeClosedBy(4, 1, -2) // = HashSet(4, 2) HashSet.rangeClosedBy(4, 1, 2)  // = HashSet() </code> </pre>
 * @param from        the first number
 * @param toInclusive the last number
 * @param step        the step
 ...
 */
  ...
  /** 
 * Creates a HashSet of long numbers starting from  {@code from}, extending to  {@code toInclusive}. <p> Examples: <pre> <code> HashSet.rangeClosed(0L, 0L)  // = HashSet(0L) HashSet.rangeClosed(2L, 0L)  // = HashSet() HashSet.rangeClosed(-2L, 2L) // = HashSet(-2L, -1L, 0L, 1L, 2L) </code> </pre>
 * @param from        the first number
 * @param toInclusive the last number
 ...
 */
  ...
  /** 
 * Creates a HashSet of long numbers starting from  {@code from}, extending to  {@code toInclusive}, with  {@code step}. <p> Examples: <pre> <code> HashSet.rangeClosedBy(1L, 3L, 1L)  // = HashSet(1L, 2L, 3L) HashSet.rangeClosedBy(1L, 4L, 2L)  // = HashSet(1L, 3L) HashSet.rangeClosedBy(4L, 1L, -2L) // = HashSet(4L, 2L) HashSet.rangeClosedBy(4L, 1L, 2L)  // = HashSet() </code> </pre>
 * @param from        the first number
 * @param toInclusive the last number
 * @param step        the step
 * @return a range of int values as specified or the empty range if<br>{@code from > toInclusive} and {@code step > 0} or<br>{@code from < toInclusive} and {@code step < 0}
 ...
 */
  ...
  @Override public HashSet<T> add(  T element){
    return new HashSet<>(tree.put(element,element));
  }
  @Override public HashSet<T> addAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public HashSet<T> clear(){
    return empty();
  }
  @Override public boolean contains(  T element){
    return tree.get(element).isDefined();
  }
  @Override public HashSet<T> diff(  Set<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public HashSet<T> distinct(){
    return this;
  }
  @Override public HashSet<T> distinctBy(  Comparator<? super T> comparator){
    Objects.requireNonNull(comparator,"comparator is null");
    return HashSet.ofAll(iterator().distinctBy(comparator));
  }
  @Override public <U>HashSet<T> distinctBy(  Function<? super T,? extends U> keyExtractor){
    Objects.requireNonNull(keyExtractor,"keyExtractor is null");
    return HashSet.ofAll(iterator().distinctBy(keyExtractor));
  }
  @Override public HashSet<T> drop(  int n){
    if (n <= 0) {
      return this;
    }
 else {
  ...
  @Override public HashSet<T> dropRight(  int n){
    return drop(n);
  }
  @Override public HashSet<T> dropUntil(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    return dropWhile(predicate.negate());
  }
  @Override public HashSet<T> dropWhile(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    final HashSet<T> dropped=HashSet.ofAll(iterator().dropWhile(predicate));
    return dropped.length() == length() ? this : dropped;
  }
  @Override public HashSet<T> filter(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    final HashSet<T> filtered=HashSet.ofAll(iterator().filter(predicate));
    return filtered.length() == length() ? this : filtered;
  }
  @Override public HashSet<T> filterNot(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    return filter(predicate.negate());
  }
  @Override public <U>HashSet<U> flatMap(  Function<? super T,? extends Iterable<? extends U>> mapper){
  ...
  @Override public <C>Map<C,HashSet<T>> groupBy(  Function<? super T,? extends C> classifier){
  ...
  @Override public Iterator<HashSet<T>> grouped(  int size){
  ...
  @Override public HashSet<T> init(){
    return tail();
  }
  @Override public Option<HashSet<T>> initOption(){
    return tailOption();
  }
  @Override public HashSet<T> intersect(  Set<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
    if (isEmpty() || elements.isEmpty()) {
      return empty();
    }
  ...
  @Override public <U>HashSet<U> map(  Function<? super T,? extends U> mapper){
    Objects.requireNonNull(mapper,"mapper is null");
    if (isEmpty()) {
      return empty();
    }
  ...
  @Override public Match.MatchMonad.Of<HashSet<T>> match(){
  ...
  @Override public Tuple2<HashSet<T>,HashSet<T>> partition(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    final Tuple2<Iterator<T>,Iterator<T>> p=iterator().partition(predicate);
    return Tuple.of(HashSet.ofAll(p._1),HashSet.ofAll(p._2));
  }
  @Override public HashSet<T> peek(  Consumer<? super T> action){
  ...
  @Override public HashSet<T> remove(  T element){
    final HashArrayMappedTrie<T,T> newTree=tree.remove(element);
    return (newTree == tree) ? this : new HashSet<>(newTree);
  }
  @Override public HashSet<T> removeAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public HashSet<T> replace(  T currentElement,  T newElement){
  ...
  @Override public HashSet<T> replaceAll(  T currentElement,  T newElement){
    return replace(currentElement,newElement);
  }
  @Override public HashSet<T> retainAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public HashSet<T> scan(  T zero,  BiFunction<? super T,? super T,? extends T> operation){
    return scanLeft(zero,operation);
  }
  @Override public <U>HashSet<U> scanLeft(  U zero,  BiFunction<? super U,? super T,? extends U> operation){
...
,HashSet::ofAll);
  ...
  @Override public <U>HashSet<U> scanRight(  U zero,  BiFunction<? super T,? super U,? extends U> operation){
    Objects.requireNonNull(operation,"operation is null");
    return Collections.scanRight(this,zero,operation,HashSet.empty(),HashSet::add,Function.identity());
  }
  @Override public Iterator<HashSet<T>> sliding(  int size){
    return sliding(size,1);
  }
  @Override public Iterator<HashSet<T>> sliding(  int size,  int step){
    return iterator().sliding(size,step).map(HashSet::ofAll);
  }
  @Override public Tuple2<HashSet<T>,HashSet<T>> span(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    final Tuple2<Iterator<T>,Iterator<T>> t=iterator().span(predicate);
    return Tuple.of(HashSet.ofAll(t._1),HashSet.ofAll(t._2));
  }
  @Override public HashSet<T> tail(){
    if (tree.isEmpty()) {
      throw new UnsupportedOperationException("tail of empty set");
    }
    return remove(head());
  }
  @Override public Option<HashSet<T>> tailOption(){
    if (tree.isEmpty()) {
      return Option.none();
    }
 else {
  ...
  @Override public HashSet<T> take(  int n){
    if (tree.size() <= n) {
      return this;
    }
    return HashSet.ofAll(() -> iterator().take(n));
  }
  @Override public HashSet<T> takeRight(  int n){
    return take(n);
  }
  @Override public HashSet<T> takeUntil(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    return takeWhile(predicate.negate());
  }
  @Override public HashSet<T> takeWhile(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    HashSet<T> taken=HashSet.ofAll(iterator().takeWhile(predicate));
    return taken.length() == length() ? this : taken;
  }
  @SuppressWarnings("unchecked") @Override public HashSet<T> union(  Set<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
    if (isEmpty()) {
      if (elements instanceof HashSet) {
        return (HashSet<T>)elements;
  ...
  @Override public <U>HashSet<U> unit(  Iterable<? extends U> iterable){
    return HashSet.ofAll(iterable);
  }
  @Override public <T1,T2>Tuple2<HashSet<T1>,HashSet<T2>> unzip(  Function<? super T,Tuple2<? extends T1,? extends T2>> unzipper){
    Objects.requireNonNull(unzipper,"unzipper is null");
    Tuple2<Iterator<T1>,Iterator<T2>> t=iterator().unzip(unzipper);
    return Tuple.of(HashSet.ofAll(t._1),HashSet.ofAll(t._2));
  }
  @Override public <T1,T2,T3>Tuple3<HashSet<T1>,HashSet<T2>,HashSet<T3>> unzip3(  Function<? super T,Tuple3<? extends T1,? extends T2,? extends T3>> unzipper){
    Objects.requireNonNull(unzipper,"unzipper is null");
  ...
  @Override public <U>HashSet<Tuple2<T,U>> zip(  Iterable<U> that){
    Objects.requireNonNull(that,"that is null");
    return HashSet.ofAll(iterator().zip(that));
  }
  @Override public <U>HashSet<Tuple2<T,U>> zipAll(  Iterable<U> that,  T thisElem,  U thatElem){
    Objects.requireNonNull(that,"that is null");
    return HashSet.ofAll(iterator().zipAll(that,thisElem,thatElem));
  }
  @Override public HashSet<Tuple2<T,Integer>> zipWithIndex(){
  ...
  public static <T>HashArrayMappedTrie<T,T> addAll(  HashArrayMappedTrie<T,T> initial,  Iterable<? extends T> additional){
...
public static final class SerializationProxy<T> implements Serializable {
    public static final long serialVersionUID=1L;
    public transient HashArrayMappedTrie<T,T> tree;
    /** 
 * Constructor for the case of serialization, called by  {@link HashSet#writeReplace()}. <p/> The constructor of a SerializationProxy takes an argument that concisely represents the logical state of an instance of the enclosing class.
 * @param tree a Cons
 */
