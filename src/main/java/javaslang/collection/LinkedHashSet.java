...
public final class LinkedHashSet<T> implements Set<T>, Serializable {
  ...
  @SuppressWarnings("unchecked") public static <T>LinkedHashSet<T> empty(){
    return (LinkedHashSet<T>)EMPTY;
  }
  /** 
 * Returns a  {@link Collector} which may be used in conjunction with{@link java.util.stream.Stream#collect(Collector)} to obtain a {@link LinkedHashSet}.
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of the given elements. <pre><code>LinkedHashSet.of(1, 2, 3, 4)</code></pre>
 * @param < T >      Component type of the LinkedHashSet.
 ...
 */
  ...
  /** 
 * Returns a LinkedHashSet containing  {@code n} values of a given Function {@code f}over a range of integer values from 0 to  {@code n - 1}.
 * @param < T > Component type of the LinkedHashSet
 ...
 */
  @SuppressWarnings("unchecked") public static <T>LinkedHashSet<T> ofAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of int numbers starting from  {@code from}, extending to  {@code toExclusive - 1}. <p> Examples: <pre> <code> LinkedHashSet.range(0, 0)  // = LinkedHashSet() LinkedHashSet.range(2, 0)  // = LinkedHashSet() LinkedHashSet.range(-2, 2) // = LinkedHashSet(-2, -1, 0, 1) </code> </pre>
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of int numbers starting from  {@code from}, extending to  {@code toExclusive - 1}, with  {@code step}. <p> Examples: <pre> <code> LinkedHashSet.rangeBy(1, 3, 1)  // = LinkedHashSet(1, 2) LinkedHashSet.rangeBy(1, 4, 2)  // = LinkedHashSet(1, 3) LinkedHashSet.rangeBy(4, 1, -2) // = LinkedHashSet(4, 2) LinkedHashSet.rangeBy(4, 1, 2)  // = LinkedHashSet() </code> </pre>
 * @param from        the first number
 * @param toExclusive the last number + 1
 * @param step        the step
 * @return a range of long values as specified or the empty range if<br>{@code from >= toInclusive} and {@code step > 0} or<br>{@code from <= toInclusive} and {@code step < 0}
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of long numbers starting from  {@code from}, extending to  {@code toExclusive - 1}. <p> Examples: <pre> <code> LinkedHashSet.range(0L, 0L)  // = LinkedHashSet() LinkedHashSet.range(2L, 0L)  // = LinkedHashSet() LinkedHashSet.range(-2L, 2L) // = LinkedHashSet(-2L, -1L, 0L, 1L) </code> </pre>
 * @param from        the first number
 * @param toExclusive the last number + 1
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of long numbers starting from  {@code from}, extending to  {@code toExclusive - 1}, with  {@code step}. <p> Examples: <pre> <code> LinkedHashSet.rangeBy(1L, 3L, 1L)  // = LinkedHashSet(1L, 2L) LinkedHashSet.rangeBy(1L, 4L, 2L)  // = LinkedHashSet(1L, 3L) LinkedHashSet.rangeBy(4L, 1L, -2L) // = LinkedHashSet(4L, 2L) LinkedHashSet.rangeBy(4L, 1L, 2L)  // = LinkedHashSet() </code> </pre>
 * @param from        the first number
 * @param toExclusive the last number + 1
 * @param step        the step
 * @return a range of long values as specified or the empty range if<br>{@code from >= toInclusive} and {@code step > 0} or<br>{@code from <= toInclusive} and {@code step < 0}
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of int numbers starting from  {@code from}, extending to  {@code toInclusive}. <p> Examples: <pre> <code> LinkedHashSet.rangeClosed(0, 0)  // = LinkedHashSet(0) LinkedHashSet.rangeClosed(2, 0)  // = LinkedHashSet() LinkedHashSet.rangeClosed(-2, 2) // = LinkedHashSet(-2, -1, 0, 1, 2) </code> </pre>
 * @param from        the first number
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of int numbers starting from  {@code from}, extending to  {@code toInclusive}, with  {@code step}. <p> Examples: <pre> <code> LinkedHashSet.rangeClosedBy(1, 3, 1)  // = LinkedHashSet(1, 2, 3) LinkedHashSet.rangeClosedBy(1, 4, 2)  // = LinkedHashSet(1, 3) LinkedHashSet.rangeClosedBy(4, 1, -2) // = LinkedHashSet(4, 2) LinkedHashSet.rangeClosedBy(4, 1, 2)  // = LinkedHashSet() </code> </pre>
 * @param from        the first number
 * @param toInclusive the last number
 * @param step        the step
 * @return a range of int values as specified or the empty range if<br>{@code from > toInclusive} and {@code step > 0} or<br>{@code from < toInclusive} and {@code step < 0}
 * @throws IllegalArgumentException if {@code step} is zero
 */
  ...
  /** 
 * Creates a LinkedHashSet of long numbers starting from  {@code from}, extending to  {@code toInclusive}. <p> Examples: <pre> <code> LinkedHashSet.rangeClosed(0L, 0L)  // = LinkedHashSet(0L) LinkedHashSet.rangeClosed(2L, 0L)  // = LinkedHashSet() LinkedHashSet.rangeClosed(-2L, 2L) // = LinkedHashSet(-2L, -1L, 0L, 1L, 2L) </code> </pre>
 * @param from        the first number
 * @param toInclusive the last number
 ...
 */
  ...
  /** 
 * Creates a LinkedHashSet of long numbers starting from  {@code from}, extending to  {@code toInclusive}, with  {@code step}. <p> Examples: <pre> <code> LinkedHashSet.rangeClosedBy(1L, 3L, 1L)  // = LinkedHashSet(1L, 2L, 3L) LinkedHashSet.rangeClosedBy(1L, 4L, 2L)  // = LinkedHashSet(1L, 3L) LinkedHashSet.rangeClosedBy(4L, 1L, -2L) // = LinkedHashSet(4L, 2L) LinkedHashSet.rangeClosedBy(4L, 1L, 2L)  // = LinkedHashSet() </code> </pre>
 * @param from        the first number
 * @param toInclusive the last number
 * @param step        the step
 * @return a range of int values as specified or the empty range if<br>{@code from > toInclusive} and {@code step > 0} or<br>{@code from < toInclusive} and {@code step < 0}
 ...
 */
  ...
  @Override public LinkedHashSet<T> add(  T element){
    return new LinkedHashSet<>(map.put(element,element));
  }
  @Override public LinkedHashSet<T> addAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public LinkedHashSet<T> clear(){
    return empty();
  }
  @Override public boolean contains(  T element){
    return map.get(element).isDefined();
  }
  @Override public LinkedHashSet<T> diff(  Set<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public LinkedHashSet<T> distinct(){
    return this;
  }
  @Override public LinkedHashSet<T> distinctBy(  Comparator<? super T> comparator){
    Objects.requireNonNull(comparator,"comparator is null");
    return LinkedHashSet.ofAll(iterator().distinctBy(comparator));
  }
  @Override public <U>LinkedHashSet<T> distinctBy(  Function<? super T,? extends U> keyExtractor){
    Objects.requireNonNull(keyExtractor,"keyExtractor is null");
    return LinkedHashSet.ofAll(iterator().distinctBy(keyExtractor));
  }
  @Override public LinkedHashSet<T> drop(  int n){
    if (n <= 0) {
      return this;
    }
 else {
  ...
  @Override public LinkedHashSet<T> dropRight(  int n){
    if (n <= 0) {
      return this;
    }
 else {
  ...
  @Override public LinkedHashSet<T> dropUntil(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    return dropWhile(predicate.negate());
  }
  @Override public LinkedHashSet<T> dropWhile(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    final LinkedHashSet<T> dropped=LinkedHashSet.ofAll(iterator().dropWhile(predicate));
    return dropped.length() == length() ? this : dropped;
  }
  @Override public LinkedHashSet<T> filter(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    final LinkedHashSet<T> filtered=LinkedHashSet.ofAll(iterator().filter(predicate));
    return filtered.length() == length() ? this : filtered;
  }
  @Override public LinkedHashSet<T> filterNot(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    return filter(predicate.negate());
  }
  @Override public <U>LinkedHashSet<U> flatMap(  Function<? super T,? extends Iterable<? extends U>> mapper){
    Objects.requireNonNull(mapper,"mapper is null");
    if (isEmpty()) {
      return empty();
    }
 else {
      final LinkedHashMap<U,U> that=foldLeft(LinkedHashMap.empty(),(tree,t) -> addAll(tree,mapper.apply(t)));
      return new LinkedHashSet<>(that);
    }
  }
  @Override public <U>U foldRight(  U zero,  BiFunction<? super T,? super U,? extends U> f){
    Objects.requireNonNull(f,"f is null");
    return iterator().foldRight(zero,f);
  }
  @Override public <C>Map<C,LinkedHashSet<T>> groupBy(  Function<? super T,? extends C> classifier){
  ...
  @Override public Iterator<LinkedHashSet<T>> grouped(  int size){
  ...
  @Override public LinkedHashSet<T> init(){
    if (map.isEmpty()) {
  ...
  @Override public Option<LinkedHashSet<T>> initOption(){
    if (map.isEmpty()) {
      return Option.none();
    }
 else {
  ...
  @Override public LinkedHashSet<T> intersect(  Set<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
    if (isEmpty() || elements.isEmpty()) {
      return empty();
    }
  ...
  @Override public <U>LinkedHashSet<U> map(  Function<? super T,? extends U> mapper){
    Objects.requireNonNull(mapper,"mapper is null");
    if (isEmpty()) {
      return empty();
    }
  ...
  @Override public Match.MatchMonad.Of<LinkedHashSet<T>> match(){
    return Match.of(this);
  }
  @Override public String mkString(  CharSequence prefix,  CharSequence delimiter,  CharSequence suffix){
    return iterator().mkString(prefix,delimiter,suffix);
  }
  @Override public Tuple2<LinkedHashSet<T>,LinkedHashSet<T>> partition(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
  ...
  @Override public LinkedHashSet<T> peek(  Consumer<? super T> action){
  ...
  @Override public LinkedHashSet<T> remove(  T element){
    final LinkedHashMap<T,T> newMap=map.remove(element);
    return (newMap == map) ? this : new LinkedHashSet<>(newMap);
  }
  @Override public LinkedHashSet<T> removeAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public LinkedHashSet<T> replace(  T currentElement,  T newElement){
  ...
  @Override public LinkedHashSet<T> replaceAll(  T currentElement,  T newElement){
    return replace(currentElement,newElement);
  }
  @Override public LinkedHashSet<T> retainAll(  Iterable<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
  ...
  @Override public LinkedHashSet<T> scan(  T zero,  BiFunction<? super T,? super T,? extends T> operation){
    return scanLeft(zero,operation);
  }
  @Override public <U>LinkedHashSet<U> scanLeft(  U zero,  BiFunction<? super U,? super T,? extends U> operation){
...
,LinkedHashSet::ofAll);
  ...
  @Override public <U>LinkedHashSet<U> scanRight(  U zero,  BiFunction<? super T,? super U,? extends U> operation){
    Objects.requireNonNull(operation,"operation is null");
    return Collections.scanRight(this,zero,operation,LinkedHashSet.empty(),LinkedHashSet::add,Function.identity());
  }
  @Override public Iterator<LinkedHashSet<T>> sliding(  int size){
    return sliding(size,1);
  }
  @Override public Iterator<LinkedHashSet<T>> sliding(  int size,  int step){
    return iterator().sliding(size,step).map(LinkedHashSet::ofAll);
  }
  @Override public Tuple2<LinkedHashSet<T>,LinkedHashSet<T>> span(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
  ...
  @Override public LinkedHashSet<T> tail(){
    if (map.isEmpty()) {
      throw new UnsupportedOperationException("tail of empty set");
    }
    return remove(head());
  }
  @Override public Option<LinkedHashSet<T>> tailOption(){
    if (map.isEmpty()) {
      return Option.none();
    }
 else {
  ...
  @Override public LinkedHashSet<T> take(  int n){
    if (map.size() <= n) {
      return this;
    }
    return LinkedHashSet.ofAll(() -> iterator().take(n));
  }
  @Override public LinkedHashSet<T> takeRight(  int n){
    if (map.size() <= n) {
      return this;
    }
    return LinkedHashSet.ofAll(() -> iterator().takeRight(n));
  }
  @Override public LinkedHashSet<T> takeUntil(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    return takeWhile(predicate.negate());
  }
  @Override public LinkedHashSet<T> takeWhile(  Predicate<? super T> predicate){
    Objects.requireNonNull(predicate,"predicate is null");
    LinkedHashSet<T> taken=LinkedHashSet.ofAll(iterator().takeWhile(predicate));
    return taken.length() == length() ? this : taken;
  }
  @SuppressWarnings("unchecked") @Override public LinkedHashSet<T> union(  Set<? extends T> elements){
    Objects.requireNonNull(elements,"elements is null");
    if (isEmpty()) {
      if (elements instanceof LinkedHashSet) {
        return (LinkedHashSet<T>)elements;
  ...
  @Override public <U>LinkedHashSet<U> unit(  Iterable<? extends U> iterable){
    return LinkedHashSet.ofAll(iterable);
  }
  @Override public <T1,T2>Tuple2<LinkedHashSet<T1>,LinkedHashSet<T2>> unzip(  Function<? super T,Tuple2<? extends T1,? extends T2>> unzipper){
    Objects.requireNonNull(unzipper,"unzipper is null");
    Tuple2<Iterator<T1>,Iterator<T2>> t=iterator().unzip(unzipper);
    return Tuple.of(LinkedHashSet.ofAll(t._1),LinkedHashSet.ofAll(t._2));
  }
  @Override public <T1,T2,T3>Tuple3<LinkedHashSet<T1>,LinkedHashSet<T2>,LinkedHashSet<T3>> unzip3(  Function<? super T,Tuple3<? extends T1,? extends T2,? extends T3>> unzipper){
    Objects.requireNonNull(unzipper,"unzipper is null");
  ...
  @Override public <U>LinkedHashSet<Tuple2<T,U>> zip(  Iterable<U> that){
    Objects.requireNonNull(that,"that is null");
    return LinkedHashSet.ofAll(iterator().zip(that));
  }
  @Override public <U>LinkedHashSet<Tuple2<T,U>> zipAll(  Iterable<U> that,  T thisElem,  U thatElem){
    Objects.requireNonNull(that,"that is null");
    return LinkedHashSet.ofAll(iterator().zipAll(that,thisElem,thatElem));
  }
  @Override public LinkedHashSet<Tuple2<T,Integer>> zipWithIndex(){
  ...
  public static <T>LinkedHashMap<T,T> addAll(  LinkedHashMap<T,T> initial,  Iterable<? extends T> additional){
  ...
  /** 
 * {@code writeReplace} method for the serialization proxy pattern.<p> The presence of this method causes the serialization system to emit a SerializationProxy instance instead of an instance of the enclosing class.
 ...
 */
  ...
  /** 
 * {@code readObject} method for the serialization proxy pattern.<p> Guarantees that the serialization system will never generate a serialized instance of the enclosing class.
 ...
 */
    ...
    /** 
 * {@code readResolve} method for the serialization proxy pattern.<p> Returns a logically equivalent instance of the enclosing class. The presence of this method causes the serialization system to translate the serialization proxy back into an instance of the enclosing class upon deserialization.
